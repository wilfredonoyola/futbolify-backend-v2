...
export const MIN_EDGE_SCORE = 40

/** Minimum value margin to consider (0% - anything less is NONE signal) */
export const MIN_MARGIN_VALOR = 0

// ============================================
// SIGNAL THRESHOLDS (Value Margin Percentages)
// ============================================

/** Margin threshold for Signal A (>= 8%) */
export const SIGNAL_A_THRESHOLD = 0.08

/** Margin threshold for Signal B (>= 3%) */
export const SIGNAL_B_THRESHOLD = 0.03
